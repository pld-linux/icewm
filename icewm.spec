...
Summary(pl.UTF-8):   IceWM - menedżer okienek X11
Name:		icewm
Version:	1.2.0pre3
Release:	1
License:	LGPL
...
Menedżer okienek pod X11. Może emulować wygląd Windows'95, OS/2 Warp
3,4, MWM. Menedżer ten próbuje wybrać najlepsze cechy dostępne w
powyższych środowiskach, jak: wiele jednocześnie obecnych przestrzeni
...
Summary(pl.UTF-8):   Zestaw tematów dla IceWM-a
Group:		Themes
Requires:	icewm
